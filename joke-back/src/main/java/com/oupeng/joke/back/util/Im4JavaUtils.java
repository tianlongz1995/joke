...
//        op.profile("*");
     ...
     * @throws Exception
     */
    public static void getGifOneFrameAsyncMode(String src, String target, int frame) throws Exception {
        if(!src.endsWith(".gif")){
            return;
        }
        createDirectory(target);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String target = "/Users/hushuang/Downloads/test2_a.jpg";

//         reduceQuality(src, target, 80);
...
//        cropImage(src, target, 0 , 0, 640, 800);
