                                        ...
                                        <div class="bs-example" style="margin: 5px;padding: 5px;">
                                            <form class="form-inline">
                                                <div class="form-group" style="display: inline-block;">
                                                    ...
                                                    <input id="jokeid" type="text" class="form-control input-sm" style="width: 150px;display: inline-block;" value="${jokeid}"
                                                           placeholder="输入ID">
                                                </div>
                                                &nbsp;&nbsp;
                                                <div class="form-group" style="display: inline-block;">
                                                    <label for="content2">关键字：</label>
                                                    <input id="content2" type="email" class="form-control input-sm" style="width: 150px;display: inline-block;" value="${content}"
                                                           placeholder="关键字">
                                                </div>
                                                &nbsp;&nbsp;
                                                <div class="form-group" style="display: inline-block;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="contentcheck" style="padding: 0px;width: 73%;height: 100%;">
                                            <div class="table-item" style="margin: 0px;padding: 0px;width: 100%;height: 100%;top:0px;bottom:0px;min-width: 100%;min-height: 50px;"
                                                 <c:if test="${joke.type == 1}">data-origin="${joke.img}"</c:if> <c:if test="${joke.type == 2}">data-src="${joke.gif}"</c:if>>
