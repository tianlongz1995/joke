                                ...
                                <tr id="cidTr">
                                    ...
                                    <td>
                                        <select class="form-control input" id="cid">
                                            <option value="1" <c:if test="${!empty banner.cid && banner.cid == 1}">selected</c:if> >趣图</option>
                                            <option value="2" <c:if test="${!empty banner.cid && banner.cid == 2}">selected</c:if> >段子</option>
