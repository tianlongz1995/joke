...
<div class="ch-container">
    <div class="row">
        ...
        <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div class="box col-md-12">
                    ...
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><a href="#" data-toggle="modal" data-target="#dataManagerModal"><i
                                    class="glyphicon glyphicon-user"></i></a> 渠道列表</h2>

                            <button onclick="addShow()" style="float: right;" class="btn btn-primary btn-xs"><i
                                    class="glyphicon glyphicon-plus"></i> 新增渠道
                            </button>
                        </div>
                            ...
                            <table id="table_list"
                                        ...
                                        <form class="form-inline">
                                            ...
                                            <div class="form-group" style="display: inline-block;">
                                                <select id="status" class="form-control input-sm"
                                                        onchange="queryList()">
                                                    <option value="0"
                                                            <c:if test="${!empty status && status == 0}">selected</c:if> >
                                                        下线
                                                    </option>
                                                    <option value="1"
                                                            <c:if test="${!empty status && status == 1}">selected</c:if> >
                                                        上线
                                                    </option>
                                                </select>
                                            </div>
                                ...
                                <c:forEach items="${list}" var="distributors">
                                    <tr>
                                        ...
                                        <td>
                                            <fmt:formatDate value="${distributors.createTime}"
                                                            pattern="yyyy-MM-dd HH:mm:ss"/>
                                        </td>
                                        <td>
                                            <fmt:formatDate value="${distributors.updateTime}"
                                                            pattern="yyyy-MM-dd HH:mm:ss"/>
                                        </td>
                                        <td>
            ...
            <div class="modal fade bs-example-modal-lg" id="newDistributor" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table id="orders-table" class="table table-hover">
                                <tr>
                                    <th>编号</th>
                                    <td><input id="addId" name="addId" type="text" class="form-control"
                                               placeholder="渠道ID"/>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <th><input id="listCenter" type="text" name="adsValue"
                                                           class="form-control input-sm" value="0"/></th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body form-inline">
                            ...
                            请输入验证码 : <input id="editCode" type="text" class="form-control input-sm"
                                            style="width: 150px;" placeholder="5分钟内有效"/>
                            &nbsp;
                            <button id="sendCode" type="button" class="btn btn-default btn-sm"
                                    onclick="sendValidationCode()">获取验证码
                            </button>
                        </div>
                        <div class="modal-footer" style="text-align: center;">
            ...
            <div class="modal fade" id="delStatusModal" tabindex="-1" role="dialog"
                 aria-labelledby="delStatusModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        ...
                        <div class="modal-body form-inline">
                            ...
                            请输入验证码 : <input id="delCode" type="text" class="form-control input-sm" style="width: 150px;"
                                            placeholder="5分钟内有效"/>
                            &nbsp;
                            <button id="delSendCode" type="button" class="btn btn-default btn-sm"
                                    onclick="sendValidationCode()">获取验证码
                            </button>
                        </div>
                        <div class="modal-footer" style="text-align: center;">
