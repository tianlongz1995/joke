                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="status" class="form-control">
                                            <option value="0"
                                                    <c:if test="${!empty source && !empty source.status && source.status == 0}">selected</c:if> >下线
                                            </option>
                                            <option value="1"
                                                    <c:if test="${!empty source && !empty source.status && source.status == 1}">selected</c:if> >上线
                                            </option>
                                        </select>
                                    </td>
                                </tr>
