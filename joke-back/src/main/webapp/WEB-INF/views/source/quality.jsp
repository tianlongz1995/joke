        ...
        <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-user"></i> 审核质量统计</h2>
                        </div>
                            ...
                            <table id="table_list" class="table table-striped table-bordered bootstrap-datatable responsive">
                                ...
                                <c:forEach items="${list}" var="sourceCrawl">
                                    <tr>
                                        ...
                                        <td><c:out value="${sourceCrawl.passed + sourceCrawl.failed}"/></td>
                                        <td><c:out value="${sourceCrawl.passed}"/></td>
                                        <td><c:out value="${sourceCrawl.failed}"/></td>
                                        <td>
                                            <c:if test="${(sourceCrawl.passed + sourceCrawl.failed) == 0 }">0</c:if>
                                            <c:if test="${(sourceCrawl.passed + sourceCrawl.failed) != 0 }">
                                                <fmt:formatNumber type="number" value="${sourceCrawl.passed / (sourceCrawl.passed + sourceCrawl.failed) * 100 }" pattern="0.00" maxFractionDigits="2"/> %
                                            </c:if>
                                        </td>
                                        <td>
            ...
            <script type="text/javascript">
                $('#query').click(function(event) {
                    ...
                    location.href = '<%=basePath%>source/quality?startTime=' + startTime +'&endTime='+endTime
                ...
                $('#export').click(function(event) {
                    ...
                    var url = '<%=basePath%>source/qualityExport?startTime=' + startTime +'&endTime='+endTime
                            + '&name=' + $("#name").val() + '&type=' + type + '&sourceType='+$("#sourceType").val();
...
//                    切换本节点的选中状态
                ...
                function turnPage(){
                    ...
                    location.href = '<%=basePath%>source/quality?startTime=' + $("#startTime").val() +'&endTime='+$("#endTime").val()
