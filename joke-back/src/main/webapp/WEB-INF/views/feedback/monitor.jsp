                            ...
                            <table id="table_list" class="table table-striped table-bordered bootstrap-datatable responsive">
                                <div class="row" style="margin-left: 0px;padding: 0px;">
                                    <div class="bs-example" style="margin: 0px 5px;padding: 0px 5px;display: inline-block;">
                                        ...
                                        <div class="form-group" style="display: inline-block;margin-bottom: 0px;">
                                            <input id="startDate" class="form-control input-sm"
                                                   <c:if test="${!empty startDate}">value="${startDate}"</c:if>
                                                   <c:if test="${empty startDate}">value="<%=date%>"
                                            </c:if> style="display: inline-block;" type="text" onfocus="WdatePicker({skin:'whyGreen',minDate:'2016-01-01',maxDate:'2066-12-31'})"/>
                                        </div>
                                        <div class="form-group" style="display: inline-block;margin-bottom: 0px;">
                                            <label>
                                        ...
                                        <div class="form-group" style="display: inline-block;margin-bottom: 0px;">
                                            <input id="endDate" class="form-control input-sm"
                                                   <c:if test="${!empty endDate}">value="${endDate}"</c:if>
                                                   <c:if test="${empty endDate}">value="<%=date%>"
                                            </c:if> style="display: inline-block;" type="text" onfocus="WdatePicker({skin:'whyGreen',minDate:'2016-01-01',maxDate:'2066-12-31'})"/>
                                        </div>
                                    </div>
                                    ...
                                    <div style="padding: 8px 0px;display: inline-block;">
                                        <select id="distributors" class="form-control input-sm" style="width: 150px;margin: 5px;display: inline-block;">
                                            ...
                                            <c:forEach items="${dList}" var="distributor" varStatus="status">
                                                <option value='<c:out value="${distributor.id}"/>'
                                                        <c:if test="${!empty distributorId && distributorId == distributor.id}">selected</c:if> ><c:out
                                                        value="${distributor.name}"/></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    &nbsp; &nbsp;
