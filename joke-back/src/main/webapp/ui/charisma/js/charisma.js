$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
        	// change the default url to ui/charisma/*
            $('#bs-css').attr('href', 'ui/charisma/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'ui/charisma/css/bootstrap-' + themeName + '.min.css');
        }
