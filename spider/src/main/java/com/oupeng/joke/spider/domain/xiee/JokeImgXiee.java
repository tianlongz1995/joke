 ...
 */
@TargetUrl("http://www.mhkkm.com/xieemanhua/\\d{4}.html")
@HelpUrl("http://www.mhkkm.com/xieemanhua/list_1_\\d{1,2}.html")
public class JokeImgXiee extends JokeImg implements AfterExtractor {
